...
int main() {
    ...
    const std::string CAPACITY_ERROR_MESSAGE =  "[Capacity] Wrong capacity of vector";
    ...
    vector_test.equal(20, vector.capacity(), CAPACITY_ERROR_MESSAGE);
    ...
    vector_test.equal(25, vector.size(), SIZE_ERROR_MESSAGE);
    vector_test.equal(40, vector.capacity(), CAPACITY_ERROR_MESSAGE);
    vector_test.equalValues(EXPECTED_VALUES[7], vector.values(), 0, vector.size(), VALUES_ERROR_MESSAGE);   
